                                ...
                                <div class="mx-2 flex flex-row sm:justify-between">
                                    <p class="font-bold">
                                        ...
                                        <span class="text-blue-400 pl-3 pr-20">
                                            <input class="h-8 rounded-lg" type="text" name="model" value="{{ old('model', $equipment->model) }}">
                                        </span>
                                    </p>
                                    <p>
                                        Serial :
                                        <span>
                                            <input class="h-8 rounded-lg" type="text" name="serial" value="{{ old('serial', $equipment->serial) }}">
                                        </span>
                                    </p>
                                </div>
                            </div>
                            <fieldset class="border-2 m-2 rounded-lg p-4 pl-6 bg-gray-200 border-gray-400 flex flex-row justify-around">
                                ...
                                <div class="flex flex-col items-center">
                                    <table class="divide-gray-200 flex flex-row rounded-lg pr-5">
                                        ...
                                        <tr>
                                            <td class="px-6 py-3 whitespace-nowrap text-xs text-gray-900 w-28 text-center">
                                                <input class="h-8 rounded-lg" type="text" name="supplier" value="{{ old('supplier', $equipment->supplier) }}">
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <table class="divide-gray-200 flex flex-row rounded-lg pr-5 pt-3">
                                        ...
                                        <tr>
                                            <td class="px-6 py-3 whitespace-nowrap text-xs text-gray-900 w-28 text-center">
                                                <input class="h-8 rounded-lg pt-0.5 w-40" type="date" name="out_date" @if(isset($equipment->out_date)) value="{{ old('out_date',  date_format(new DateTime($equipment->out_date), 'Y-m-d')) }}"@endif>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                            ...
                                            <td class="px-6 py-3 whitespace-nowrap text-xs text-gray-900 w-28 text-center">
                                                <select class="h-8 rounded-lg text-sm pt-1" name="equipment_type" id="">
                                                    ...
                                                    @foreach($equipmentTypes as $equipmentType)
                                                        <option @if($equipment->equipment_type == old('equipment_type', $equipmentType->id)) selected @endif value="{{ $equipmentType->id }}"> {{ $equipmentType->keyword }} </option>
                                                    @endforeach
                                                </select>
                                            </td>
                                        </tr>
